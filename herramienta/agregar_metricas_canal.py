...
Nota: el archivo de origen (Ventas_samsung.xlsx) NO está en este
repositorio público por confidencialidad de los datos (ver README.md y
DECISIONES.md, iteración 7). Las salidas ya calculadas y anonimizadas
para los 3 meses usados en este trabajo están en herramienta/salidas/.
"""
