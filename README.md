...
través de ~20-71 canales comerciales — marketplaces, bancos, retailers) y
...
- **La elección de modelo (Haiku 4.5) está respaldada por una comparación
  real, no solo teórica:** se corrieron los mismos 3 meses con Haiku y se
  comparó contra Sonnet — 13 de 15 canales prioritarios coinciden
  exactamente entre ambos modelos, con 68% menos costo. Ver
  `corridas/comparacion_haiku_vs_sonnet/`.
